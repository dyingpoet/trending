...
do
    ...
    cmd="/usr/local/bin/hive  --hiveconf start_partition=$s --hiveconf end_partition=$e --hiveconf dthour=\'$dt1p\' --hiveconf dt=\'$dt\' -f /home/zzhao3/2016_06_Trending/Sam_club_trending/from_Wei/order_1.hql"
