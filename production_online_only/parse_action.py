...
for line in sys.stdin:
    ...
    if vid not in ('', '\N', '#'):
        ...
        print '|'.join([vid, bucket, visit_epoch, action_map.get('item_view', '0'), action_map.get('add_to_cart', '0'), action_map.get('online', '0'), action_map.get('buyClub', '0')])
    if mid not in ('', '\N', '#'):
        ...
        print '|'.join([mid, bucket, visit_epoch, action_map.get('item_view', '0'), action_map.get('add_to_cart', '0'), action_map.get('online', '0'), action_map.get('buyClub', '0')])
